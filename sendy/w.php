...
<?php
	...
	if($table == 'campaigns') 
		$q = 'SELECT campaigns.from_email, campaigns.html_text, campaigns.sent, campaigns.send_date, login.timezone FROM campaigns, login WHERE campaigns.userID = login.id AND campaigns.id = '.$campaign_id;
