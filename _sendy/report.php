    	...
    	<div class="row-fluid">
	    	<div class="span6">
	    		<div class="well">
			    	...
			    	<h3><span class="badge badge-info" style="font-size:16px;"><?php echo $click_per;?>%</span> <?php echo _('clicked a link');?> <span class="label"><?php echo get_click_percentage($cid);?> <?php echo _('unique clicks');?></span></h3>
			    </div>
	    	</div>
