...
editableItems['.pix_builder_bg, .confirm_page_2'] = ['background-image', 'background-color', 'padding-top', 'padding-bottom', 'box-shadow', 'background-size'];
...
var editableContent = ['.editContent', '.pix_edit', '.navbar a', 'button', 'a.btn', '.footer a:not(.fa)', '.tableWrapper'];
