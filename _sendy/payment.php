...
<input type="hidden" name="return" value="<?php echo APP_PATH;?>/sending?i=<?php echo $app?>&c=<?php echo $campaign_id;?>&e=<?php echo $email_list;?>&s=true&date=<?php echo $the_date;?>&timezone=<?php echo $timezone;?>&recipients=<?php echo $total_recipients;?>">
<?php else:?>
<input type="hidden" name="return" value="<?php echo APP_PATH;?>/sending?i=<?php echo $app?>&c=<?php echo $campaign_id;?>&e=<?php echo $email_list_implode;?>&cr=<?php echo $cron;?>&recipients=<?php echo $total_recipients;?>">
<?php endif;?>
